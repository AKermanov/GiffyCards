        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    CustomerPhotoId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AspNetUsers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_CustomerPhotos_CustomerPhotoId",
                        column: x => x.CustomerPhotoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AspNetUsers_CustomerPhotoId",
                table: "AspNetUsers",
                column: "CustomerPhotoId");
