        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    StrenghtType = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Accessories_Descriptions_DescriptionId",
                        column: x => x.DescriptionId,
                        principalTable: "Descriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Accessories_Questions_QuestionId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cigars_Descriptions_DescriptionId",
                        column: x => x.DescriptionId,
                        principalTable: "Descriptions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Cigars_Strenghts_StrenghtId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhotoText = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerPhotos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerPhotos_Cigars_CigarId",
                        column: x => x.CigarId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductTypes_Accessories_AccessoriesId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(nullable: false),
                    DeletedOn = table.Column<DateTime>(nullable: true),
                    CustomerPhotoId = table.Column<int>(nullable: true),
                    CustomerPhotoId1 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderProducts_Accessories_AccessorieId",
                        column: x => x.AccessorieId,
                        principalTable: "Accessories",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrderProducts_Cigars_CigarId",
                        column: x => x.CigarId,
                        principalTable: "Cigars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accessories_DescriptionId",
                table: "Accessories",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Accessories_QuestionId",
                table: "Accessories",
                column: "QuestionId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cigars_DescriptionId",
                table: "Cigars",
                column: "DescriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_Cigars_IsDeleted",
                table: "Cigars",
                column: "IsDeleted");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cigars_StrenghtId",
                table: "Cigars",
                column: "StrenghtId");

            migrationBuilder.CreateIndex(
                name: "IX_Cigars_TasteId",
                table: "Cigars",
                column: "TasteId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerPhotos_CigarId",
                table: "CustomerPhotos",
                column: "CigarId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerPhotos_IsDeleted",
                table: "CustomerPhotos",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_Descriptions_IsDeleted",
                table: "Descriptions",
                column: "IsDeleted");

            migrationBuilder.CreateIndex(
                name: "IX_OrderProducts_AccessorieId",
                table: "OrderProducts",
                column: "AccessorieId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderProducts_CigarId",
                table: "OrderProducts",
                column: "CigarId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductTypes_AccessoriesId",
                table: "ProductTypes",
                column: "AccessoriesId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductTypes_CigarId",
                table: "ProductTypes",
                column: "CigarId");
